...
<template>
    ...
    >
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ms-4 sm:text-start">
                    <h3 class="text-lg font-medium text-navy-900">
                        <slot name="title" />
                    </h3>

                    <div class="mt-4 text-sm text-graphite-500">
                        <slot name="content" />
                    </div>
                </div>
            </div>
        ...
        <div class="flex flex-row justify-end px-6 py-4 bg-graphite-50 text-end">
            <slot name="footer" />
        </div>
    </Modal>
</template>
