...
{
    /**
     * Dispatch a notification to all enabled webhook integrations for a user.
     * Supports Slack & Microsoft Teams (Incoming Webhook format).
     */
    public function notify(User $user, string $title, string $body, array $facts = [], ?string $link = null): void
    {
        ...
        foreach ($integrations as $integration) {
            ...
            try {
                ...
                Log::channel('daily')->warning('Webhook notification failed', [
    ...
    /** Test a single webhook URL without persisting. */
